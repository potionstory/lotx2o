...
class Card extends React.Component {
  ...
  handleAdd() {
    ...
    if (n < 5) {
      this.setState({
        ...
        number: update(this.state.number, {
          $push: [["", "", "", "", "", ""]]
        })
      });
    } else {
  ...
  handleRefreshAll() {
    ...
    Promise.all(emptyNumber).then(function() {
      _this.setState({
        number: emptyNumber
      });
    });
        ...
        {this.state.number.map((n, i) => {
          return (
            <LottoNo
              ...
              onIndex={i}
              onNumber={n}
              onCreateNumber={this.handleNumber}
  ...
  loopUserLotto() {
    if (this.props.onUserCount) {
      ...
      return <span className="box-empty">LOTTO EMPTY</span>;
    }
  }
  ...
  render() {
      ...
      <div id="save-modal" className="modal">
        ...
        <div className="modal-footer">
          <a
            ...
            className="modal-action modal-close waves-effect waves-light btn blue darken-2"
          >
            Yes
          </a>
          <a
            href="#!"
            className="modal-action modal-close waves-effect waves-light btn red darken-2"
          >
            No
          </a>
        </div>
    ...
    const buttonSave = (
      <a
        ...
        className={
          (this.state.ready ? "light-green" : "grey lighten-1") +
          " waves-effect waves-light col s12 btn-large"
        }
      >
        SAVE
      </a>
