...
import { getStatusRequest, logoutRequest, withdrawRequest } from 'actions/authentication';
        ...
        this.props.getStatusRequest().then(
            () => {
                if (!this.props.authStatus.valid) {
                    ...
                    let $toastContent = $('<span style="color:#FFB4BA"> Your session is expired, please log in agagin</span>');
